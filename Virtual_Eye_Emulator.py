...
class EyeTracker:
    ...
    def process_frame(self, frame):
        ...
        if results.multi_face_landmarks:
            ...
            # Dibujar landmarks en el frame original
            ...
            # Dibujar información sobre los ojos
            cv2.circle(frame, left_center, 5, (0, 255, 0), -1)
            cv2.circle(frame, right_center, 5, (0, 255, 0), -1)
            
            # Información textual en frame principal
            cv2.putText(frame, f"Direccion: {gaze_direction}", (10, 30), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
            cv2.putText(frame, f"EAR_L: {left_ear:.3f}", (10, 60), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
            cv2.putText(frame, f"EAR_R: {right_ear:.3f}", (10, 90), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
            cv2.putText(frame, f"Ceja_L: {left_brow_height:.2f}", (10, 120), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 100, 255), 2)
            cv2.putText(frame, f"Ceja_R: {right_brow_height:.2f}", (10, 150), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 100, 255), 2)
